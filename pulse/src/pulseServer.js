...
async function fetchExchangeRate() {
  try {
    ...
    if (data.result === "success") {
      ...
      devLog('Next USD/EUR update:', new Date(nextUpdateTime).toUTCString());
...
function emitTradingData(data) {
  ...
  devLog('Emitting orderbook data:', {
      tradeCount: orderBookTrades.length,
