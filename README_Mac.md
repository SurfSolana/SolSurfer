...
```
   ...
   - Make sure `"MONITOR_MODE": true` is set
   - This lets you watch the bot's decisions without risking real money
...
- Always start with Monitor Mode on
...
VSCode is a powerful text editor that makes coding easier.
...
Note: Installation might take a few minutes. After installing, you might need to restart Terminal.

If the 'code' command isn't recognized after installation:
...
2. Open the settings file in VSCode:
...
1. Start with Test Mode:
   - Open `user/settings.json` in VSCode:
